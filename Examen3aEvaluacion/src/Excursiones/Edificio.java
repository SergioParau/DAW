...
public abstract class Edificio {
	...
	public Edificio(int id, String nombre, String estilo, String arquitecto,
	...
	DatosEdificio= "Edificio [id=" + id + ", nombre=" + nombre + ", estilo="
				+ estilo + ", arquitecto=" + arquitecto + ", anyo=" + anyo
				+ ", direccion=" + direccion + ", precioEntrada="
				+ precioEntrada + "]";
